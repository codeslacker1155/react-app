...
function BookDetailsPage({ id }) { // Receive id as a prop
  ...
  const renderBook = useCallback(() => {
    ...
    const isbn = volumeInfo.industryIdentifiers.find(identifier => identifier.type === 'ISBN_13' || identifier.type === 'ISBN_10');
    ...
    const template = `
      <div class="book">
        ...
        <p class="book-info"><strong>ISBN: </strong>{{isbn.identifier}}</p>
